...
function CuppingFeature() {
  return <div className="mechanism-feature-visual">
    {/* eslint-disable-next-line @next/next/no-img-element */}<img src="/images/mechanism/cupping-reference.webp" alt="Scientific illustration showing controlled suction, local tissue lift, and mechanical input during cupping" />
  </div>;
}

function HerbalFeature() {
  return <div className="mechanism-feature-visual herbal-feature-visual">
    {/* eslint-disable-next-line @next/next/no-img-element */}<img src="/images/herbal-medicine-user.webp" alt="Traditional Chinese herbs arranged for herbal medicine care" />
...
function AcupunctureReferenceAnimation({ playing }: { playing: boolean }) {
  ...
  >
    ...
    <img className="reference-animation-base" src="/images/mechanism/acupuncture-communication-reference.webp" alt="" />
