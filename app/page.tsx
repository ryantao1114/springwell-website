...
export default function Home() {
  return <PageShell>
    ...
    <section className={`${styles.section} ${styles.providerSection}`}><div className={`container ${styles.providerGrid}`}><div className={styles.providerImage}><Image src="/images/provider-renjinming-2026.webp" alt="Renjinming Dai, licensed acupuncturist at Springwell" fill unoptimized sizes="(max-width: 860px) 100vw, 43vw" /></div><div className={styles.providerCopy}><p className="eyebrow">Meet your acupuncturist</p><h2>Renjinming Dai, L.Ac.</h2><p className={styles.credentials}>Virginia Licensed Acupuncturist · Diplomate of Acupuncture (NCCAOM)</p><div className={styles.providerPoints}><div><h3>Specialized training</h3><p>Graduate training in Traditional Chinese Medicine gynecology, with more than 5 years of focused experience in women's and reproductive health.</p></div><div><h3>Biomedical perspective</h3><p>Training and research experience spanning traditional Chinese medicine, biomedical engineering, and pain science.</p></div><div><h3>Individualized care</h3><p>Treatment is adapted to your symptoms, medical history, current care, and response, not a one size fits all protocol.</p></div></div><p className={styles.providerConsultation}>New patient? <Link href={site.bookingUrl} target="_blank" rel="noreferrer">Schedule a consultation</Link> to talk through your goals and see if acupuncture is a good fit.</p></div></div></section>
