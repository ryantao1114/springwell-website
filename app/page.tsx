...
const specialties = [
  { title: "Women’s Health & Fertility", text: "Menstrual health, fertility, IUI and IVF support, and care through different stages of women’s health.", href: "/care/womens-health-fertility", image: "/images/home-womens-health-hero-hd.webp", alt: "A calm conversation about women’s health and fertility care" },
...
function SectionHeading({eyebrow,title,text}:{eyebrow:string;title:string;text:string}){return <div className={styles.sectionHeading}><div><p className="eyebrow">{eyebrow}</p><h2>{title}</h2></div><p>{text}</p></div>}
