...
const focusAreas = [
  ...
  },
  {
    ...
    image: "/images/home-pain-management-upload.webp",
    alt: "A person holding their neck and lower back while experiencing pain",
  ...
  },
  {
    ...
    image: "/images/home-stress-sleep-upload.webp",
    alt: "A patient resting calmly during a gentle facial acupuncture treatment",
          ...
          <div className="start-here-grid">
            <article>
              <div className="start-step-image">
                <Image src="/images/first-session-assessment.jpeg" alt="Practitioner and patient discussing health concerns" fill sizes="(max-width: 680px) 100vw, 33vw" />
            ...
            <article>
              <div className="start-step-image">
                <Image src="/images/first-session-treatment.jpg" alt="Acupuncture treatment being provided" fill sizes="(max-width: 680px) 100vw, 33vw" />
            ...
            <article>
              <div className="start-step-image">
                <Image src="/images/first-session-rest.jpeg" alt="Patient resting calmly during acupuncture care" fill sizes="(max-width: 680px) 100vw, 33vw" />
